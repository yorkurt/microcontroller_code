#ifndef AltSSPololuQik_h
#define AltSSPololuQik_h
...
class PololuQik : public AltSoftSerial
{
  public:
    PololuQik(unsigned char resetPin);

    void init(long speed = 57600);
...
{
  public:
    PololuQik2s12v10(unsigned char resetPin) : PololuQik(resetPin) {}
